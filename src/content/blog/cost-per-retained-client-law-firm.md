...
seo_title: "Cost Per Retained Client: The Only Law Firm Marketing Metric That Matters"
...
draft: false
image: "/images/blog/cost-per-retained-client-law-firm.jpg"
---
...
**Cost Per Retained Client = Total Marketing Spend divided by Total Retained Clients**
...
1. **Total spend** on that channel (ad spend + agency fees + tools)
2. **Leads generated** from that channel (requires proper attribution)
3. **Consultations booked** from those leads
4. **Clients retained** from those consultations

Then: **Channel spend divided by Clients retained from that channel = Channel CPRC**
...
1. **Call tracking with source attribution** — every inbound call tagged to the marketing channel that generated it
2. **CRM or intake system** — tracking lead status from inquiry through consultation through retention
3. **Consistent intake process** — asking every prospect how they found you and recording it
4. **Monthly reconciliation** — matching your marketing spend reports to your retention data
