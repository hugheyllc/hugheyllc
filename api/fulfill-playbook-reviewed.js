// Vercel Serverless Function — fulfills "Always Reviewed. Always Ranked." playbook
// after a successful Stripe Checkout session. Idempotent via session metadata.
import { Resend } from 'resend';

const PLAYBOOK_URL = 'https://hugheyllc.com/playbook/always-reviewed-a7f3e9b2.html';
...
function buyerEmailHtml(firstName) {
  ...
  return `
    <div style="font-family: Georgia, serif; max-width: 640px; color: #09131F;">
      ...
      <p style="font-size: 15px; line-height: 1.7; color: #444;">Your copy of <strong>Always Reviewed. Always Ranked. — The Law Firm Review System Playbook</strong> is below. One link, yours forever — bookmark it.</p>
      ...
      <p style="font-size: 15px; line-height: 1.7; color: #444;">Start with Chapter 3 — the Review Request System. That is the core of the playbook. Get your direct review link, drop the email template into your CMS or CRM, and run the 3-touch sequence on your next closed case. You will have a working system inside a week.</p>

      <p style="font-size: 15px; line-height: 1.7; color: #444;">Run into something the playbook does not cover, or want a second set of eyes once the system is up? Reply to this email — it comes straight to me.</p>
  ...
  return `
    <div style="font-family: Georgia, serif; max-width: 600px; color: #09131F;">
      ...
      <table style="width: 100%; border-collapse: collapse;">
        ...
        <tr><td style="padding: 8px 0; font-weight: bold;">Resource</td><td>Always Reviewed. Always Ranked. Playbook</td></tr>
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const userEmailPromise = resend.emails.send({
      ...
      subject: 'Your Always Reviewed Playbook — Download Inside',
    ...
    const storeLeadPromise = supabaseKey
      ? fetch(`${SUPABASE_URL}/rest/v1/hugheyllc_leads`, {
          ...
          body: JSON.stringify({
            ...
            email,
            source: 'always-reviewed-playbook',
          }),
