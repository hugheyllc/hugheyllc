...
// Reads /data/.openclaw/workspace/playbooks/always-found-always-local-FULL.md
// Writes public/playbook/always-found-f3a9d2c1.html
...
const mdPath = '/data/.openclaw/workspace/playbooks/always-found-always-local-FULL.md';
const outPath = resolve(repoRoot, 'public/playbook/always-found-f3a9d2c1.html');
...
<title>Always Found. Always Local. — The Law Firm Local SEO Playbook | Hughey LLC</title>
<style>
  :root {
    --ink: #1a1a1a;
    --rule: #d8d2c4;
